        ...
        default:
            {
                ...
                ws_uri: "wss://kms.artisky.net:8888/kurento",

                ice_servers: [{
                    "url": "turn:artisky.io:3478?transport=udp",
                    "username": "amuser",
                    "credential": "AaBbCc1234"
                }]
...
window.addEventListener('load', function () {
    ...
    startButton.addEventListener("click", function () {
        ...
        if (args.ice_servers) {
            console.log("Use ICE servers: " + JSON.stringify(args.ice_servers));
            options.configuration = {
                iceServers: args.ice_servers
            };
        } else {
            ...
            kurentoClient(args.ws_uri, function (error, client) {
                ...
                client.create("MediaPipeline", function (error, _pipeline) {
                    ...
                    pipeline.create("WebRtcEndpoint", function (error, webRtc) {
                        ...
                        console.log(customizeOffer);

                        webRtc.processOffer(customizeOffer, function (error, sdpAnswer) {
                            if (error) return onError(error);
